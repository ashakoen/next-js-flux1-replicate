            ...
            <CardHeader className="relative">
                ...
                {images.length > 0 && (
                    ...
                    >
                        ...
                        <span className="text-sm">Drop Pack</span>
                    </div>
                )}
...
<div className="text-center space-y-4">
                    ...
                    <div 
                        {...getRootProps()} 
                        className={`w-full max-w-md p-8 rounded-lg border-2 border-dashed transition-all duration-200 ${
                            isDragActive 
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center gap-2">
                            ...
                            <p className="text-sm text-muted-foreground">Drop Image Pack Here</p>
                        </div>
                    </div>
</div>
    </>
