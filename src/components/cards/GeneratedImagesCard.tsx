...
interface GeneratedImagesCardProps {
  ...
  onRegenerateWithSeed: (
    seed: number,
    modelType: "dev" | "schnell" | "pro" | "pro-ultra" | "recraftv3"
  ) => void;
...
export function GeneratedImagesCard({
  ...
  const cleanupBlobUrl = useCallback((url: string): void => {
  ...
  const [swinirTaskType, setSwinirTaskType] = useState<
    "Real-World Image Super-Resolution-Large" | "Real-World Image Super-Resolution-Medium"
  ...
  const getImageExpiry = useCallback(
    (timestamp: string) => {
  ...
  useEffect(() => {
    const interval: ReturnType<typeof setInterval> = setInterval(async () => {
      ...
      const imagesFromDB = await db.getImages();
    ...
    <>
      <Card className="flex flex-col w-full h-[calc(100vh-8rem)] md:overflow-hidden">
        <CardHeader className="relative">
              ...
              <Tooltip>
                ...
                <TooltipContent>
                  <p>
                    ...
                    <br />
                    Save to bucket or download to keep.
                  </p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          ...
          <CardDescription>
            Your MagicBox creations will show up here. Have fun!
          </CardDescription>
        </CardHeader>
            ...
            <div className="h-full overflow-y-auto">
              <div className="grid grid-cols-2 md:grid-cols-3 3xl:grid-cols-4 gap-8 p-2 overflow-x-hidden">
                <AnimatePresence mode="popLayout">
                  ...
                  {[...images].reverse().map((image: GeneratedImage, index: number) => {
                    const imageExpiry = image.timestamp
                      ? getImageExpiry(image.timestamp)
                      : null;
                    ...
                    return (
                      ...
                      >
                          ...
                          className="absolute top-2 left-1/2 -translate-x-1/2 z-50 opacity-0 group-hover:opacity-100 transition-opacity"
                                            onClick={async () => {
                                                try {
                                                    ...
                                                    // Create new image object with blob data
                                                    const bucketImage = {
                                                        ...image,
                                                        blobData: blob,
                                                    ...
                                                    await onAddToBucket(bucketImage);
                        ...
                        <Dialog
                          open={openImageUrl === image.url}
                          onOpenChange={(open) =>
                            setOpenImageUrl(open ? image.url : null)
                          }
                        >
                            ...
                            <div className="cursor-pointer">
                              <div className="relative w-full pb-[100%] transition-transform duration-200 transform group-hover:scale-105">
                                <Image
                                  ...
                                  loading={index < 6 ? "eager" : "lazy"} // Lazy load the rest
                                />
                                {(() => {
                                  if (!image.timestamp) return null;
                                  const { isExpired, timeLeft } = getImageExpiry(
                                    image.timestamp
                                  );
                                  const showWarning =
                          ...
                          {openImageUrl === image.url && (
                            <DialogContent className="sm:max-w-[1000px] max-h-[90vh] p-0 overflow-y-auto">
                              <div className="flex h-full">
                                {/* Left side - Main Image */}
                                <div className="relative bg-black/5 dark:bg-white/5 flex-1">
                                ...
                                {/* Right side - Details */}
                                <div className="w-[340px] flex flex-col bg-white dark:bg-gray-800 p-6 overflow-y-auto">
                                  <div className="mb-4">
                                  ...
                                  <div className="space-y-6 w-full">
                                    ...
                                    <div
                                      className={`grid ${
                                        !image.seed ||
                                        image.model?.includes("real-esrgan") ||
                                        image.model?.includes("swinir")
                                          ? "grid-cols-1"
                                          : "grid-cols-2"
                                      } gap-3`}
                                    >
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                      ...
                                      {/* Luma Reference Images (shown lower; kept placeholders here) */}
                                      {image.image_reference_url && (
                                        <div>
                                          ...
                                          <p className="text-sm mt-0.5">
                                            Weight: {image.image_reference_weight}
                                          </p>
                                        </div>
                                      )}
                                      ...
                                      {image.style_reference_url && (
                                        <div>
                                          ...
                                          <p className="text-sm mt-0.5">
                                            Weight: {image.style_reference_weight}
                                          </p>
                                        </div>
                                      )}
                                    ...
                                    <div className="flex items-center gap-1.5">
                                      ...
                                      <span className="text-sm">
                                        {(() => {
                                          const history = [];
                                          if (image.isImg2Img)
                                            history.push("Image to Image");
                                          if (
                                            image.model?.includes("real-esrgan") ||
                                            image.model?.includes("swinir")
                                          )
                                            history.push("Upscaled");
                                    ...
                                    {image.extra_lora_scale !== undefined &&
                                      image.extra_lora && (
                                        <div>
                                          <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400">
                                            Extra LoRA Scale
                                          ...
                                          <div className="space-y-1.5">
                                            ...
                                            {image.prompt_strength && (
                                              <p className="text-xs text-gray-500">
                                                Strength: {image.prompt_strength}
                                              </p>
                                            )}
                                          </div>
                                        )}
                                          ...
                                          <div className="space-y-1.5">
                                            ...
                                            <div className="relative h-20 w-20 rounded overflow-hidden">
                                              ...
                                              <Image
                                                ...
                                                className="rounded border border-white/40 dark:border-white/25"
                                              />
                                            </div>
                                          </div>
                                        )}
                                  ...
                                  <div className="mt-auto pt-4 flex flex-col gap-2">
                                        ...
                                        <Button
                                          ...
                                          onClick={() => {
                                            ...
                                            if (image.model?.includes("flux")) {
                                              ...
                                              image.model?.includes("recraftv3")
                                            ) {
                                              modelType = "recraftv3";
                                            } else {
                                              modelType = "dev";
                                            ...
                                            setOpenImageUrl(null);
                                            toast.success(
                                              "Regenerating with a lower seed value"
                                            );
                                          }}
                                          disabled={image.isEdited}
                                        >
                                        ...
                                        onClick={async () => {
                                          try {
                                            ...
                                            const bucketImage = {
                                              ...image,
                                              blobData: blob,
                                              url: image.url // Keep original URL for reference
                                            };

                                            await onAddToBucket(bucketImage);
                                          } catch (error) {
                                            console.error(
                                              "Failed to add image to bucket:",
                                              error
                                            );
                                            toast.error("Failed to add image to bucket");
                                          }
                                    ...
                                    {!image.isEdited && (
                                      <Button
                                        ...
                                        variant="outline"
                                        onClick={() =>
                                          onDownloadWithConfig(image.url, image)
                                        }
                                        disabled={image.isEdited}
                                      >
                                            ...
                                            <div className="flex items-center space-x-2">
                                              <Checkbox
                                                ...
                                                onCheckedChange={(checked) =>
                                                  setFaceEnhance(checked as boolean)
                                                }
                                              />
                                              <Label htmlFor="face-enhance">
                                                Enhance faces
                                              </Label>
                                            </div>
                                          )}
                                          ...
                                          {upscaleModel === "swinir" && (
                                            <div className="space-y-2">
                                              ...
                                              >
                                                ...
                                                <SelectContent>
                                                  <SelectItem value="Real-World Image Super-Resolution-Large">
                                                    Large
                                                  </SelectItem>
                                                  <SelectItem value="Real-World Image Super-Resolution-Medium">
                                                    Medium
                                                  </SelectItem>
                                                </SelectContent>
                                              </Select>
                          ...
                          !image.isEdited && (
                            ...
                            >
                              ...
                              <span className="sr-only">
                                Regenerate with{" "}
                                {parseInt(image.seed?.toString() || "0") < 1000
                                  ? "increased"
                                  : "decreased"}{" "}
                                seed
                              </span>
                  ...
                  <div className="text-center space-y-4">
                    <div className="space-y-2">
                      <p className="text-sm text-muted-foreground">
                        Your MagicBox canvas is empty for now
                      </p>
